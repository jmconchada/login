            ...
            while ($row = $result->fetch_assoc()) {
                echo "<tr>
                        ...
                        <td class='btn-container'>
                            <a href='update_user.php?email={$row['email']}' class='btn update-btn'>Update</a>
                            <a href='users.php?delete_email={$row['email']}' class='btn delete-btn' onclick='return confirm(\"Are you sure you want to delete this user?\")'>Delete</a>
                        </td>
                      </tr>";
            }
        } else {
